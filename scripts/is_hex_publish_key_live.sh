...
#
# This asked /api/users/me until 0.26.4, which answers 404 for a key with no
# user behind it. The organisation key this package publishes with is one, so
# the check refused a key that had published three versions that same day.
#
